...
const MobileChangeLayout: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'On mobile, Creator and Location columns are hidden. Resize the viewport to see the layout change.'
      }
    }
  }
}
...
export default meta
export { Default, DisabledHoverEffect, MobileChangeLayout, SingleColumn, WithBorders, WithoutHeader, WithoutHoverEffect }
