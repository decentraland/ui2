...
/** The MANA-pegged credits mark: the original gradient bloom, restored.
 *
 *  Deliberately NOT the same artwork as ShopCreditsIcon. The marketplace shows both balances in the
 *  same row, and they are different currencies: `creditsBalance` is MANA-pegged and expires, while
 *  `shopCreditsBalance` is the shop's USD-pegged balance. Drawing both with the C mark left that row
 *  reading as one currency listed twice, told apart only by text colour.
 *
 *  Its gradients are baked in, so unlike the C mark it cannot follow its surface's text colour. That
 *  is why it is scoped to this one chip instead of replacing Icon/CreditsIcon everywhere. */
const ManaCreditsIcon = memo(function ManaCreditsIcon(props: IconProps) {
  return (
    <svg width="20" height="20" viewBox="0 0 256 256" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <path
        ...
        fill="url(#dcl-nav-credits3)"
      />
      <path
        d="M62.1592 164.392C56.491 162.05 53.7942 155.557 56.1357 149.889L64.9349 128.589L56.0954 107.305C53.7431 101.641 56.4276 95.1432 62.0914 92.7908L83.3749 83.9513L92.1741 62.6512C94.5157 56.983 101.009 54.2862 106.677 56.6278L127.977 65.4269L149.261 56.5874C154.925 54.2351 161.423 56.9196 163.775 62.5834L172.615 83.8669L193.915 92.6661C199.583 95.0077 202.28 101.501 199.938 107.169L191.139 128.469L199.979 149.753C202.331 155.417 199.646 161.915 193.983 164.267L172.699 173.107L163.9 194.407C161.558 200.075 155.065 202.772 149.397 200.43L128.097 191.631L106.813 200.471C101.149 202.823 94.6511 200.138 92.2988 194.475L83.4593 173.191L62.1592 164.392Z"
        fill="url(#dcl-nav-credits4)"
      />
      ...
      <path
        ...
        fillRule="evenodd"
        clipRule="evenodd"
        d="M151.392 93.1941L151.381 92.0695C151.252 79.4163 140.711 69.2321 127.796 69.3636C114.88 69.4951 104.549 79.8919 104.678 92.545L104.689 93.6697L96.1087 93.757C93.0489 93.7882 90.5044 96.0762 90.2087 99.0624L83.3993 167.822C83.0553 171.295 85.8595 174.293 89.4189 174.257L168.873 173.448C172.441 173.411 175.187 170.342 174.757 166.868L166.271 98.265C165.904 95.2956 163.318 93.0727 160.267 93.1037L151.392 93.1941ZM138.208 92.2036C138.152 86.6465 133.53 82.2212 127.927 82.2783C122.324 82.3353 117.794 86.8538 117.85 92.4109L117.862 93.5355L138.22 93.3282L138.208 92.2036ZM151.506 104.348L151.578 111.392C151.614 114.958 148.694 117.879 145.057 117.917C141.419 117.954 138.441 115.093 138.405 111.526L138.333 104.482L117.975 104.689L118.047 111.734C118.083 115.3 115.164 118.221 111.527 118.258C107.889 118.295 104.911 115.434 104.875 111.868L104.803 104.823L101.064 104.861L95.3026 163.042L162.738 162.356L155.557 104.306L151.506 104.348Z"
        fill="url(#dcl-nav-credits5)"
      />
      <defs>
        <linearGradient id="dcl-nav-credits0" x1="211.108" y1="218.484" x2="77.4791" y2="27.1647" gradientUnits="userSpaceOnUse">
          <stop stopColor="#9BFFFF" />
          <stop offset="0.5" stopColor="#B8B9FF" />
          <stop offset="0.885" stopColor="#FFCBFF" />
          <stop offset="1" stopColor="#FDFCFF" />
        </linearGradient>
        <linearGradient id="dcl-nav-credits1" x1="225.88" y1="218.975" x2="71.9492" y2="33.3822" gradientUnits="userSpaceOnUse">
          <stop stopColor="#5285BF" />
          <stop offset="1" stopColor="#AE66F0" />
        </linearGradient>
        <linearGradient id="dcl-nav-credits2" x1="195.385" y1="221.054" x2="91.1662" y2="16.6319" gradientUnits="userSpaceOnUse">
          <stop stopColor="#9BFFFF" />
          <stop offset="0.5" stopColor="#B8B9FF" />
          <stop offset="1" stopColor="#FFCBFF" />
        </linearGradient>
        <linearGradient id="dcl-nav-credits3" x1="103.148" y1="42.8184" x2="132.876" y2="134.167" gradientUnits="userSpaceOnUse">
          <stop stopColor="white" />
          <stop offset="1" stopColor="white" stopOpacity="0" />
        </linearGradient>
        <linearGradient id="dcl-nav-credits4" x1="109.14" y1="55.9116" x2="124.459" y2="109.497" gradientUnits="userSpaceOnUse">
          <stop stopColor="white" />
          <stop offset="1" stopColor="white" stopOpacity="0" />
        </linearGradient>
        <linearGradient id="dcl-nav-credits5" x1="129.146" y1="173.852" x2="128.082" y2="69.3607" gradientUnits="userSpaceOnUse">
 ...
 *
 *  Same artwork as Icon/CreditsIcon, deliberately and not by accident. The duplication is the MUI
 *  boundary, not the glyph: Icon/CreditsIcon wraps it in MUI's SvgIcon (for the toggle and the user
 *  menu, which style via `sx`/`fontSize`), while the navbar renders plain SVG to keep MUI out of its
 *  inline chips. Change one and change the other.
 *
 *  This mark means the shop's USD-pegged credits. The MANA-pegged balance has its own, above. */
