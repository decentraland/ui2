 ...
 *
 *  Same artwork as Icon/CreditsIcon — deliberately, not by accident: credits are one currency with one
 *  mark. The duplication is the MUI boundary, not the glyph. Icon/CreditsIcon wraps it in MUI's SvgIcon
 *  (for the toggle and the user menu, which style via `sx`/`fontSize`), while the navbar renders plain
 *  SVG to keep MUI out of its inline chips. Change one and change the other. */
