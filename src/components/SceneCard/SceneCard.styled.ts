...
const StyledCardMedia = styled(CardMedia)<{ shrinkOnHover?: boolean }>(({ theme, shrinkOnHover }) => ({
...
const LeftBadge = styled(Box)<{ showOnHover?: boolean }>(({ theme, showOnHover }) => ({
...
const RightBadge = styled(Box)<{ showOnHover?: boolean }>(({ theme, showOnHover }) => ({
  marginLeft: 'auto',
...
const AvatarContainer = styled(Box)<{ showOnHover?: boolean }>(({ theme, showOnHover }) => ({
  display: 'flex',
  gap: theme.spacing(1),
  alignItems: 'center',
  flex: '1 1 auto',
...
const LocationChipContainer = styled(Box)<{ showOnHover?: boolean }>(({ theme, showOnHover }) => ({
  flex: '1 1 auto',
  minWidth: 0,
  maxWidth: '50%',
  display: 'flex',
...
const JumpInButtonContainer = styled(Box)<{ showOnHover?: boolean }>(({ theme, showOnHover }) => ({
  ...(showOnHover && {
    [theme.breakpoints.up('sm')]: {
      opacity: 0,
      height: 0,
