...
const meta: Meta<typeof CreditsToggle> = {
  ...
  argTypes: {
    ...
    showLearnMore: {
      control: "boolean",
      description:
        'Show "Learn More" button instead of credits amount when user has no credits',
    },
    label: {
      control: "text",
...
const NoCreditsWithLearnMore: Story = {
  ...
  args: {
    ...
    learnMoreUrl:
      "https://decentraland.org/blog/announcements/marketplace-credits",
  },
}
