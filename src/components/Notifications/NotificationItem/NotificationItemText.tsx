...
type NotificationItemTextProps<N extends ReadableNotification> =
...
function NotificationItemTextComponent<N extends ReadableNotification>(
  props: NotificationItemTextProps<N>
) {
  const {
    description,
    descriptionHref,
...
const NotificationItemText = React.memo(
  NotificationItemTextComponent
) as unknown as typeof NotificationItemTextComponent
