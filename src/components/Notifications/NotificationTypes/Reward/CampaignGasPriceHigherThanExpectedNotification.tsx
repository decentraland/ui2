...
import { CampaignGasPriceHigherThanExpectedNotificationProps, CommonNotificationProps } from '../../Notifications.types'
...
const CampaignGasPriceHigherThanExpectedNotification = React.memo(
  (props: CommonNotificationProps<CampaignGasPriceHigherThanExpectedNotificationProps>) => {
    return <CampaignNotification {...props} i18n={campaignGasPriceHigherThanExpectedI18n} />
  }
)
