const creditsClaimReminderI18n = {
  ...
  zh: {
    description:
      "你已经赚取了积分，但还没有领取！在每周奖励面板中完成CAPTCHA，以在星期日23:59 UTC之前领取你的积分。",
    title: "领取你的积分",
  },
} as const
...
const creditsCompleteYourWeeklyGoalsI18n = {
  en: {
    description:
      "Don't miss out on your Credits! Complete your weekly goals before the week resets (23:59 UTC Sunday).",
...
const creditsDoNotMissOutI18n = {
  en: {
    description:
      "Marketplace Credits are waiting! Jump in to complete your weekly goals before the week resets (23:59 UTC Sunday).",
...
const creditsExpireSoonReminderI18n = {
  en: {
    description:
      "Your Marketplace Credits expire in one week on {date}. Spend them before it's too late!",
    title: "Your Credits Expire Soon",
  },
  es: {
    description:
      "Tus Créditos de Marketplace expiran en una semana el {date}. ¡Gástalos antes de que sea demasiado tarde!",
    title: "Tus Créditos Expiran Pronto",
  },
  zh: {
    description:
      "你的Marketplace积分将在一周后的{date}过期。请在过期前使用它们！",
    title: "你的积分即将过期",
  },
} as const
...
const creditsOnDemandGrantedI18n = {
  en: {
    description:
      "Congrats! You've earned {amount} extra Credits for this season. Make sure to use them before they expire!",
