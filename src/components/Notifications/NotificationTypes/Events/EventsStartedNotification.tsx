...
const EventsStartedNotification = React.memo((props: CommonNotificationProps<EventsStartedNotificationProps>) => {
  ...
  return (
    <NotificationItemText
      ...
      description={
        <>
          {eventStartedI18n[locale].description.start} <Link href={notification.metadata.link}>{notification.metadata.name}</Link>{' '}
