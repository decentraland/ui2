...
import { CommonNotificationProps, GovernanceVotingEndedVoterNotificationProps } from '../../Notifications.types'

const GovernanceVotingEndedVoterNotification = React.memo((props: CommonNotificationProps<GovernanceVotingEndedVoterNotificationProps>) => {
