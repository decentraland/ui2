...
export {
  ...
  governanceCoauthorRequestedI18n,
  governanceNewCommentOnProjectUpdateI18n,
  governanceNewCommentOnProposalI18n,
  governancePitchPassedI18n,
  governanceProposalEnactedI18n,
  governanceTenderPassedI18n,
  governanceVotingEndedVoterI18n
}
