...
const WorldsAccessRestrictedNotification = React.memo((props: CommonNotificationProps<WorldsAccessRestrictedNotificationProps>) => {
    ...
    <NotificationItemText
      ...
      description={
        <>
          ...
          <Link href={notification.metadata.url}>{worldsAccessRestrictedI18n[locale].description.link_text}</Link>.
        </>
      }
    />
  )
