...
const WorldsMissingResourcesNotification = React.memo((props: CommonNotificationProps<WorldsMissingResourcesNotificationProps>) => {
    ...
    <NotificationItemText
      ...
      description={
        <>
          ...
          <Link href={notification.metadata.url}>{worldsMissingResourcesI18n[locale].description.link_text}</Link>{' '}
