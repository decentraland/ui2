...
const ReferralNotification = React.memo((props: ReferralCommonNotificationProps) => {
  ...
  return (
    <NotificationItemText
      image={isNewTierReached ? notification.metadata.image : <ReferralInvitedUserAcceptedIcon width={48} height={48} />}
      imageBackgroundColor={
        isNewTierReached && notification.metadata.rarity ? getBGColorByRarity(notification.metadata.rarity) : 'transparent'
      }
