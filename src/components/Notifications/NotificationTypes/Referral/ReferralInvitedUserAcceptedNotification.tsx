...
import { CommonNotificationProps, ReferralInvitedUsersAcceptedNotificationProps } from '../../Notifications.types'
...
const ReferralInvitedUserAcceptedNotification = React.memo(
  (props: CommonNotificationProps<ReferralInvitedUsersAcceptedNotificationProps>) => {
    return <ReferralNotification {...props} i18n={referralInvitedUserAcceptedI18n} />
  }
)
