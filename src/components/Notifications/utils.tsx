...
function formatMana(mana: string, maximumFractionDigits = MAXIMUM_FRACTION_DIGITS): string {
...
const NotificationComponentByType: DecentralandNotificationComponentByType<DCLNotificationProps> = {
  ...
  [NotificationType.EVENT_DELETED]: EventDeletedNotification,
...
const replaceWithValues = (str: string, values: Record<string, string | JSX.Element>): JSX.Element | string => {
