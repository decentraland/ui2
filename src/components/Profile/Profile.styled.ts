...
const ProfileContainer = styled('span')<ProfileBaseProps>(({ theme, inline = true, size = 'normal' }) => ({
...
})<Pick<ProfileBaseProps, 'size' | 'highlightName'>>(({ theme, size = 'normal', highlightName = false }) => {
...
export { ProfileContainer, ProfileName, ProfileNameWithAddressContainer, ProfileCopyButton, ProfileCopyIcon }
