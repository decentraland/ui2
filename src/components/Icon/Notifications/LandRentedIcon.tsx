...
const LandRentedIcon = React.memo((props: SvgIconProps) => {
  return (
    <SvgIcon {...props}>
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" {...props}>
        <circle cx="12" cy="12" r="12" fill="url(#paint0_linear_32_9732)" />
        <path
          d="M11.1555 15.947L11.1559 15.9465L12.1178 15.3694L10.0764 14.1444L7 15.9901L9.04183 17.2151L11.1555 15.947Z"
          fill="#FCFCFC"
        />
        <path
          d="M12.3947 15.4692L11.4329 16.0463L14.1859 17.6986L17 16.0099L14.247 14.3576L12.3952 15.4687L12.3947 15.4692Z"
          fill="#FCFCFC"
        />
        <path
          d="M14.0253 14.225L12.8108 13.4963C12.8108 13.4963 12.4676 14.4144 12 14.4286C11.5218 14.4431 11.1407 13.5056 11.1407 13.5056L10.2979 14.0113L12.3393 15.2362L14.0253 14.225Z"
          fill="#FCFCFC"
        />
        <path
          d="M11.2114 16.1795L9.2635 17.3481L12.0165 19L13.9644 17.8313L11.2114 16.1795Z"
          fill="#FCFCFC"
        />
        <path
