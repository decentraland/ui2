...
const ManaMainnetIcon = React.memo((props: SvgIconProps) => {
  return (
    <SvgIcon {...props}>
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" {...props}>
        ...
        />
        <defs>
          <linearGradient id="paint0_linear_32_9725" x1="-0.631579" y1="0.631579" x2="24" y2="24" gradientUnits="userSpaceOnUse">
