...
/**
 * The credits currency mark: a hexagonal "C" badge.
 *
 * Drawn in `currentColor` so each surface's own text colour drives it — the navbar's credits chip is
 * lavender, the shop's is off-white, and the toggle inherits whatever row it sits in. The mark this
 * replaced was a multi-layer gradient bloom with its own baked-in palette, which could not follow the
