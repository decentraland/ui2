    ...
    <SvgIcon {...props}>
      ...
      >
        <g clipPath="url(#clip0_1474_35775)">
          ...
          />
          <path
            d="M11.7 21.1L20 26.0143L28.2857 21.1L20 32.8L11.7 21.1Z"
            fill="url(#paint1_linear_1474_35775)"
          />
          <path
            d="M20 24.1857L11.7 19.2714L20 6.20001L28.3 19.2714L20 24.1857Z"
            fill="white"
          />
        </g>
        <defs>
          <linearGradient
            id="paint0_linear_1474_35775"
            x1="0"
            y1="0"
            x2="20"
            y2="40"
