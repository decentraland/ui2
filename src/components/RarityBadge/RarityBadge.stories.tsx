...
const Small: Story = {
  ...
  render: () => {
    return (
      <RarityBadgeContainer>
        {Rarity.getRarities().map(rarity => (
          <RarityBadge rarity={rarity as Rarity} key={rarity as string} size="small" />
        ))}
      </RarityBadgeContainer>
    )
  }
...
const MediumSquare: Story = {
  ...
  render: () => {
    return (
      <RarityBadgeContainer>
        {Rarity.getRarities().map(rarity => (
          <RarityBadge rarity={rarity as Rarity} key={rarity as string} size="medium" square />
        ))}
      </RarityBadgeContainer>
    )
  }
...
const SmallSquare: Story = {
  ...
  render: () => {
    return (
      <RarityBadgeContainer>
        {Rarity.getRarities().map(rarity => (
          <RarityBadge rarity={rarity as Rarity} key={rarity as string} size="small" square />
        ))}
      </RarityBadgeContainer>
    )
  }
...
export default meta
export { Common, Uncommon, Rare, Epic, Legendary, Exotic, Mythic, Unique, Square, WithTooltip, Medium, Small, MediumSquare, SmallSquare }
