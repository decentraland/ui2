  ...
  MuiAppBar: {
    styleOverrides: {
      root: {
        ...
        transition: 'box-Shadow 200ms cubic-bezier(0,1, 0.15, 1), background-image 200ms cubic-bezier(0,1, 0.15, 1)',
        backgroundImage: 'none',
        backgroundColor: palette.mode === 'dark' ? 'rgba(24,20,26, 0.9)' : 'rgba(255,255,255, 0.9)'
      }
    }
  },
  MuiButton: {
